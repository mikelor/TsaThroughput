...
python src/tsa_throughput/src/visualization/createMonthlyBarChart.py -a "$airport_codes"


# Create a figure for all of the airports
python src/tsa_throughput/src/visualization/createFigures.py -a "Total"
python src/tsa_throughput/src/visualization/createMonthlyBarChart.py -a "Total"
cd scripts
